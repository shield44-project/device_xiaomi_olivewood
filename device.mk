...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_sdm439_sku1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_sdm439_sku1.xml \
...
# Keylayouts
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/keylayout/,$(TARGET_COPY_OUT_VENDOR)/etc)
