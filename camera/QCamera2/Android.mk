...
LOCAL_CFLAGS := -Wall -Wextra -Wno-compound-token-split-by-macro
...
LOCAL_HEADER_LIBRARIES += camera_fdleak_headers
...
include $(CLEAR_VARS)
LOCAL_MODULE := camera_fdleak_headers
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/stack/common/leak
include $(BUILD_HEADER_LIBRARY)
